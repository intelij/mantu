            ...
            <div class="collapse navbar-collapse mt-lg-0 mt-3" id="mainNavbar">
              <ul class="nav navbar-nav main-menu ms-auto me-3">
                ...
                <ul class="dropdown-menu" aria-labelledby="servicesDropdown"  style="background: #17081e;">
                    ...
                    <li><a class="dropdown-item" href="/plumbing">Plumbing Services</a></li><li><a class="dropdown-item" href="/swimming-pool">Swimming Pools</a></li><li><a class="dropdown-item" href="/swimming-pool">Swimming Pools</a></li><li><a class="dropdown-item" href="/hampers">Hampers & Gifts</a></li><li><a class="dropdown-item" href="/hampers">Hampers & Gifts</a></li>
