<html lang="en" crxemulator="">
  ...
  <head>
    ...
    <title>Mantu | Swimming Pool Construction, Repairs & Maintenance in Matabeleland, Zimbabwe</title>

    <!-- =========================================================
        SEO Meta Tags for Swimming Pool Services
    ========================================================== -->
    <meta name="description" content="Professional swimming pool construction, repairs, and maintenance services in Matabeleland, Zimbabwe. Mantu builds durable pools, fixes leaks, restores damaged structures, installs pumps and filtration systems, and provides full refurbishments. Trusted by diaspora clients for transparent reporting, quality workmanship, and reliable project supervision.">

    <meta name="keywords" content="swimming pool construction Zimbabwe, pool builders Bulawayo, pool repairs Zimbabwe, pool refurbishment Matabeleland, leak detection Bulawayo, pool maintenance Zimbabwe, pool tiling Bulawayo, pool pump installation, filtration systems Zimbabwe, pool resurfacing, Mantu pool services, diaspora project management Zimbabwe, trusted pool contractors, affordable pool construction, custom swimming pools Zimbabwe">

    <meta name="author" content="Mantu">
    <meta name="robots" content="index, follow">

    <meta name="news_keywords" content="swimming pool construction, pool repairs, pool builders Zimbabwe, pool refurbishment Bulawayo, pool leak repair, pool resurfacing, Matabeleland contractors, Mantu pool services, diaspora construction support Zimbabwe, trusted pool experts">
    <!-- Canonical URL -->
  ...
  <body>
    ...
    <main class="main-wrapper">
      <section class="banner-section has-bimg" style="background-image: url(' images/banner/swimming.jpg ');">
          ...
          <div class="row gy-5 justify-content-between align-items-center">
            ...
            <div class="banner-content wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="0.5s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.3s; animation-name: fadeInUp;">
                <div class="banner-top-title">Matebeleland’s Trusted Diaspora Companion Platform</div>
                    <h2 class="banner-title">Swimming Pool Construction & Expert Repair Services</h2>
                    <p class="text-white mt-3">
                        Bring your dream pool to life with Mantu’s professional swimming pool construction and repair services.
                        We design, build, and restore pools that combine style, strength, and long-lasting performance — tailored to your property and preferences.
                        Our experienced builders handle structural work, waterproofing, finishing, filtration systems, and full refurbishments.
                        For clients abroad, we provide complete accountability with progress photos, transparent updates, and reliable on-site supervision.
                        Whether you need a brand-new pool or repairs to bring your existing one back to perfection, trust Mantu to deliver quality workmanship you can depend on.
                    </p>
                    <div class="d-sm-flex d-none flex-wrap align-items-center justify-content-lg-start justify-content-center mt-2">
                        <a href="assets/downloads/pool-construction-report.pdf" target="_blank" class="btn main-btn me-3 mt-3">View Sample Pool Report</a>
                    </div>
                </div>
        ...
        <div class="container">
          <div class="row gy-4 justify-content-between align-items-center">
            <div class="col-lg-12 wow fadeInLeft" data-wow-delay="0.3s" data-wow-duration="0.5s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.3s; animation-name: fadeInLeft;">
              <h2 class="counter-title text-white" style="text-align: center">From premium kitchen designs to flawless tiling and ceiling finishes, Mantu delivers world class workmanship with accountability and transparency.</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <section class="feature-section pt-100 pb-100">
        <div class="container">
            ...
            <div class="col-lg-5 pe-lg-5 wow fadeInLeft" data-wow-delay="0.3s" data-wow-duration="0.5s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.3s; animation-name: fadeInLeft;">
                ...
                <h2 class="title text-purple">Swimming Pool Construction</h2>
                <p class="mt-2">
                    Our swimming pool construction services combine structural strength, modern design, and premium finishing.
                    From excavation and shell building to plumbing, tiling, and filtration systems, Mantu delivers pools built for beauty, durability, and long-term performance.
                </p>
                <p class="mt-2">
                    We manage every stage of the project — no hidden costs — giving you complete confidence in quality, accountability, and timely delivery.
                </p>

                <h2 class="title text-purple" style="padding-top: 20px">Pool Repairs & Refurbishments</h2>
                <p class="mt-2">
                    Whether your pool needs leak sealing, pump repairs, surface refinishing, retiling, or structural correction, our repair specialists restore your pool to perfect working condition.
                    We use industry-grade materials and advanced methods to ensure long-lasting results.
                </p>
                <p class="mt-2">
                    Every repair project is thoroughly supervised, ensuring accuracy, safety, and flawless workmanship from start to finish.
                </p>

                <h2 class="title text-purple" style="padding-top: 20px">Pool Maintenance & Upgrades</h2>
                <p class="mt-2">
                    Maintain your pool in excellent condition with our professional maintenance services, including water treatment, equipment checks, cleaning, and system optimisation.
                    We also offer upgrades such as LED lighting, heat pumps, solar systems, and filtration enhancements to modernize your swimming experience.
                </p>
                <p class="mt-2">
                    Our team works efficiently and neatly, ensuring minimal disruption and a polished finish that enhances both functionality and appearance.
                </p>
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s" data-wow-duration="0.5s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.3s; animation-name: fadeInRight;">
                <div class="feature-thumb">
                    <img src="/images/banner/pool.png" alt="image">
                </div>
                </div>
