...
<html lang="en">
  <!-- =========================================================
    ...
    <!-- =========================================================
        SEO Meta Tags
    ========================================================== -->
    <meta name="description" content="Mantu offers professional borehole drilling, installation, and maintenance services across Matabeleland, Zimbabwe. Get clean, reliable water supply solutions from trusted and certified drillers.">
    <meta name="keywords" content="Mantu, borehole drilling Bulawayo, water drilling Zimbabwe, borehole installation Matabeleland, borehole maintenance, pump installation, water solutions, trusted drillers Zimbabwe">
    <meta name="author" content="Mantu">
    <meta name="robots" content="index, follow">
    <meta name="news_keywords" content="Mantu, borehole drilling, water supply, Bulawayo, Matabeleland, Zimbabwe, pump repair, clean water, installation, maintenance, water solutions">
          ...
          <div class="row gy-5 justify-content-between align-items-center">
            <div class="col-lg-7 text-lg-start text-center">
              <div class="banner-content wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="0.5s">
                <div class="banner-top-title">Reliable Borehole Drilling & Water Solutions</div>
                <h2 class="banner-title">Connecting Homeowners, Farmers, and Businesses with Trusted Borehole Experts</h2>
                <p class="text-white mt-3">Mantu makes it easy to access clean water with professional drilling, pump installation, and borehole maintenance services. Whether you need a new borehole or repairs to an existing one, Mantu connects you with qualified water specialists you can trust.</p>
