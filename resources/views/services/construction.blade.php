        ...
        <div class="container">
          <div class="row gy-5 justify-content-between align-items-center">
            ...
            <div class="banner-content wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="0.5s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.3s; animation-name: fadeInUp;">
                ...
                <div class="banner-top-title">Matabeleland’s Trusted Construction Experts</div>
                <h2 class="banner-title">Professional Building, Renovation & Finishing Solutions</h2>
                <p class="text-white mt-3">
                  Mantu delivers expert construction services — from foundation to finishing. Whether you’re building new property, renovating, or upgrading interiors, we provide quality workmanship, certified professionals, and clear progress updates for local and diaspora clients.
                </p>
                <div class="d-sm-flex flex-wrap align-items-center mt-2">
                  <a href="assets/downloads/construction-project-sample.pdf" target="_blank" class="btn main-btn me-3 mt-3">View Sample Construction Report</a>
                </div>
      ...
      <section class="feature-section pt-100 pb-100">
        <div class="container">
            ...
            <div class="col-lg-5 pe-lg-5 wow fadeInLeft" data-wow-delay="0.3s" data-wow-duration="0.5s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.3s; animation-name: fadeInLeft;">
                <h2 class="title text-purple">Residential & Commercial Construction</h2>
              <p>We handle all types of construction — from family homes and duplexes to commercial spaces and offices, ensuring quality workmanship and adherence to timelines.</p>

              <h2 class="title text-purple pt-4">Renovations & Structural Upgrades</h2>
              <p>Transform existing structures with modern finishes, reinforced foundations, and smart layouts tailored to your needs and property type.</p>

              <h2 class="title text-purple pt-4">Tiling, Plastering & Ceiling Work</h2>
              <p>We deliver flawless interior finishes with precision tiling, plastering, and ceiling installation that enhance both aesthetics and durability.</p>

              <h2 class="title text-purple pt-4">Diaspora Project Oversight</h2>
              <p>Clients abroad receive verified reports, videos, and progress documentation — ensuring transparency and trust from start to completion.</p>
