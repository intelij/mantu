...
<html lang="en">
  <!-- =========================================================
    ...
    <!-- =========================================================
        SEO Meta Tags
    ========================================================== -->
    <meta name="description" content="Mantu offers reliable truck hire and logistics services across Matabeleland. Whether for construction, deliveries, or relocation, our fleet is ready to move your load safely and efficiently.">
    <meta name="keywords" content="Mantu, truck hire Bulawayo, logistics Zimbabwe, transport Matabeleland, haulage, moving services, construction trucks, deliveries, heavy load transport">
    <meta name="author" content="Mantu">
    <meta name="robots" content="index, follow">
    <meta name="news_keywords" content="Mantu, truck hire, logistics, Bulawayo, Matabeleland, Zimbabwe, transport, haulage, moving, delivery">
            ...
            <div class="collapse navbar-collapse mt-lg-0 mt-3" id="mainNavbar">
              <ul class="nav navbar-nav main-menu ms-auto me-3">
                ...
                <ul class="dropdown-menu" aria-labelledby="servicesDropdown"  style="background: #17081e;">
                    ...
                    <li><a class="dropdown-item" href="/plumbing">Plumbing Services</a></li><li><a class="dropdown-item" href="/swimming-pool">Swimming Pools</a><li><a class="dropdown-item" href="/swimming-pool">Swimming Pools</a></li><li><a class="dropdown-item" href="/hampers">Hampers & Gifts</a></li><a class="dropdown-item" href="/hampers">Hampers & Gifts</a></li>
          ...
          <div class="row gy-5 justify-content-between align-items-center">
            <div class="col-lg-7 text-lg-start text-center">
              <div class="banner-content wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="0.5s">
                <div class="banner-top-title">Dependable Truck Hire & Logistics Services</div>
                <h2 class="banner-title">Connecting Businesses, Builders, and Homeowners with Reliable Transport Solutions</h2>
                <p class="text-white mt-3">Mantu offers easy access to trucks for construction, deliveries, and relocations. Whether you’re moving materials or hauling loads, Mantu connects you with professional drivers and well-maintained vehicles ready to move your goods safely.</p>
