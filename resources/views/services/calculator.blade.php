<html lang="en" crxemulator="">
  ...
  <head>
    ...
    <title>Mantu | Qualified Tradespeople &amp; Home Services in Matabeleland, Zimbabwe</title>
    <!-- =========================================================
        SEO Meta Tags
    ========================================================== -->
  ...
  <body>
            ...
            <div class="collapse navbar-collapse mt-lg-0 mt-3" id="mainNavbar">
              <ul class="nav navbar-nav main-menu ms-auto me-3">
                ...
                <ul class="dropdown-menu" aria-labelledby="servicesDropdown"  style="background: #17081e;">
                    ...
                    <li><a class="dropdown-item" href="/plumbing">Plumbing Services</a></li><li><a class="dropdown-item" href="/swimming-pool">Swimming Pools</a></li><area><a class="dropdown-item" href="/hampers">Hampers & Gifts</a></li>
    ...
    <main class="main-wrapper">
      <section class="banner-section has-bimg" style="background-image: url(' images/banner/kitchen.png ');">
        ...
        <div class="container">
          <div class="row gy-5 justify-content-between align-items-center">
            ...
            <div class="banner-content wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="0.5s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.3s; animation-name: fadeInUp;">
                ...
                <h2 class="banner-title">Modern Kitchens, Expert Tiling & Quality Finishes</h2>
                <p class="text-white mt-3">
                Transform your home with Mantu’s modern kitchen and tiling solutions — designed for beauty, durability, and precision.
                Our skilled carpenters, tilers, and electricians handle every aspect of your project, from layout design and cabinetry to plumbing and finishing touches.
                For clients abroad, we ensure full accountability with progress photos, transparent communication, and on-site supervision.
                Your dream kitchen deserves professional delivery you can trust — wherever you are in the world.
                </p>
                <div class="d-sm-flex d-none flex-wrap align-items-center justify-content-lg-start justify-content-center mt-2">
                <a href="assets/downloads/kitchen-tiling-report.pdf" target="_blank" class="btn main-btn me-3 mt-3">View Sample Kitchen Report</a>
                </div>
            </div>
            </div>
      ...
      <section class="feature-section pt-100 pb-100">
        <div class="container">
            ...
            <div class="col-lg-5 pe-lg-5 wow fadeInLeft" data-wow-delay="0.3s" data-wow-duration="0.5s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.3s; animation-name: fadeInLeft;">
                    <h2 class="title text-purple">Modern Kitchen Installation</h2>
                    <p class="mt-2">
                        Our modern kitchen installations blend elegance, functionality, and quality. From cabinetry to countertops and lighting, Mantu ensures every detail reflects your style while maintaining the highest build standards.
                    </p>
                    <p class="mt-2">We handle everything in-house — no middlemen, no hidden costs — ensuring trust, reliability, and timely delivery.</p>


                    <h2 class="title text-purple" style="padding-top: 20px">Tiling Services</h2>
                    <p class="mt-2">
                        Whether it's floor, wall, or decorative tiling, our craftsmen deliver precision and durability. Mantu’s tiling team uses top-grade materials and tools to achieve flawless finishes in kitchens, bathrooms, and living areas.
                    </p>
                    <p class="mt-2">
                        Every project is supervised for quality assurance, ensuring neat lines, perfect alignment, and long-lasting results.
                    </p>


                    <h2 class="title text-purple"  style="padding-top: 20px">Ceiling Installation</h2>
                    <p class="mt-2">
                        From suspended ceilings to modern gypsum designs, Mantu’s ceiling experts enhance your interiors with both function and style. We specialize in moisture-resistant, durable installations ideal for any residential or commercial setting.
                    </p>
                    <p class="mt-2">Our approach ensures minimal disruption, clean finishes, and a final product that adds comfort and elegance to your space.</p>
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s" data-wow-duration="0.5s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 0.3s; animation-name: fadeInRight;">
                <div class="feature-thumb">
                    <img src="images/banner/_.jpeg" alt="image">
                </div>
                </div>
